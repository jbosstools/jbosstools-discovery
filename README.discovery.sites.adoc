...
** http://download.jboss.org/jbosstools/mars/development/updates/discovery.central/4.3.0.*/jbosstools-directory.xml
** https://devstudio.redhat.com/9.0/development/updates/discovery.central/9.0.0.*/devstudio-directory.xml
