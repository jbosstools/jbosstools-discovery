...
mvn clean install -f jbosstools/org.jboss.tools.central.discovery/pom.xml \
  ...
  -DEXTRAS_SITE=http://download.jboss.org/jbosstools/neon/snapshots/updates/central/master/,http://download.jboss.org/jbosstools/targetplatforms/jbtcentraltarget/4.6x.0.*/REPO/
----
...
mvn clean install -f jbdevstudio/com.jboss.jbds.central.discovery/pom.xml \
  ...
  -DEXTRAS_SITE=https://devstudio.redhat.com/10.0/snapshots/updates/central/master/,https://devstudio.redhat.com/targetplatforms/jbtcentraltarget/4.6x.0.*/REPO/
----
...
mvn clean install -f jbosstools/org.jboss.tools.central.discovery.earlyaccess/pom.xml \
  -DUPDATE_SITE=http://download.jboss.org/jbosstools/neon/snapshots/updates/core/master/ \
  -DEXTRAS_SITE=http://download.jboss.org/jbosstools/neon/snapshots/updates/central/master/,http://download.jboss.org/jbosstools/targetplatforms/jbtcentraltarget/4.6x.0.*/REPO/,http://download.jboss.org/jbosstools/neon/snapshots/updates/earlyaccess/master/,http://download.jboss.org/jbosstools/targetplatforms/jbtearlyaccesstarget/4.6x.0.*/REPO/
----
...
mvn clean install -f jbdevstudio/com.jboss.jbds.central.discovery.earlyaccess/pom.xml \
  -DUPDATE_SITE=https://devstudio.redhat.com/10.0/snapshots/updates/core/master/ \
  -DEXTRAS_SITE=https://devstudio.redhat.com/10.0/snapshots/updates/central/master/,https://devstudio.redhat.com/targetplatforms/jbtcentraltarget/4.6x.0.*/REPO/,https://devstudio.redhat.com/10.0/snapshots/updates/earlyaccess/master/,https://devstudio.redhat.com/targetplatforms/jbtearlyaccesstarget/4.6x.0.*/REPO/
----
...
for d in jbtcentral jbtearlyaccess; do
  pushd ${d}target
    ...
    pushd multiple && mvn -U org.jboss.tools.tycho-plugins:target-platform-utils:1.0.0-SNAPSHOT:fix-versions -DtargetFile=${d}-multiple.target && rm -f ${d}-multiple.target ${d}-multiple.target_update_hints.txt && mv -f ${d}-multiple.target_fixedVersion.target ${d}-multiple.target && popd
...
3. Install Eclipse (eg., 4.6 Neon JEE bundle)
...
1. Install Eclipse (eg., 4.6 Neon JEE bundle)
...
** http://download.jboss.org/jbosstools/neon/development/updates/discovery.central/4.4.4.*/jbosstools-directory.xml
** https://devstudio.redhat.com/10.0/development/updates/discovery.central/10.4.0.*/devstudio-directory.xml
