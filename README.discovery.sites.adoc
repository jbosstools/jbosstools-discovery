...
** http://download.jboss.org/jbosstools/neon/development/updates/discovery.central/4.4.3.*/jbosstools-directory.xml
** https://devstudio.redhat.com/10.0/development/updates/discovery.central/10.3.0.*/devstudio-directory.xml
